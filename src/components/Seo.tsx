...
export function Seo({
  ...
  useEffect(() => {
    ...
    const pageLabelMap: Record<string, string> = {
      ...
      "/healthcare-teams/family-medicine": "Family Medicine",
      "/healthcare-teams/dental-practices": "Dental Practices",
      "/healthcare-teams/mental-health": "Mental Health Providers",
      "/healthcare-teams/specialists": "Specialist Practices",
      "/healthcare-teams/telehealth": "Telehealth Providers",
      "/healthcare-teams/healthcare-organizations": "Healthcare Organizations",
      "/videos": "Video Hub",
      "/products": "Products",
      "/contact": "Contact",
