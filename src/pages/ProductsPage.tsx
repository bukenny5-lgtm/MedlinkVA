...
export function ProductsPage() {
  ...
  return <article className="space-y-0">
    <Seo title="Virtual Medical Assistant Resources | MedLink VA" description="Explore Virtual Medical Assistant resources, healthcare administration templates, insurance verification worksheets, remote patient monitoring logs, scheduling tools, and practical classes from MedLink VA." />
